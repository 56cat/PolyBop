...
public class MauSacJDiaLog extends javax.swing.JDialog {
    ...
    private void filltotableThuongHieu() {
        ...
        for (MauSac x : list) {
            model.addRow(new Object[]{x.getMa_MauSac(), x.getTen_MauSac(), x.isTrangThai() ? "Còn Hàng" : "Hết Hàng"});
        }
...
//        txtMaVi.setText(sp.getIDVi() + "");
        ...
        txtTen.setText(sp.getTen_MauSac());
    ...
    private boolean Checknull() {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (id.equalsIgnoreCase(list.get(i).getMa_MauSac())) {
                ...
                txtMa.requestFocus();
                return true;
            } else if (tensp.equalsIgnoreCase(list.get(i).getTen_MauSac())) {
