...
public class SPCTView extends javax.swing.JPanel {
    ...
    public SPCTView(String maVi, String tenVi) {
        initComponents();
        init();
        this.maVi = maVi;
...
//            String LoaiVi = (String) cbo_loaiVi.getSelectedItem();
            ...
            for (SanPhamCT_ID x : service.getDaTaSPCT(maVi)) {
                if (maCTSP.equalsIgnoreCase(x.getMaCTSP())
                        ...
                        & ChatLieu.equalsIgnoreCase(x.getTen_ChatLieu())) //                        & LoaiVi.equalsIgnoreCase(x.getTenLoaiSanPham())) {
                {
