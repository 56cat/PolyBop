...
public class ChatLieuJDiaLog extends javax.swing.JDialog {
    ...
    private void filltotableChatLieu() {
        ...
        for (ChatLieu x : list) {
            model.addRow(new Object[]{x.getMa_ChatLieu(), x.getTen_ChatLieu(), x.isTrangThai() ? "Còn Hàng" : "Hết Hàng"});
        }
...
//        txtMaVi.setText(sp.getIDVi() + "");
        ...
        txtTen.setText(sp.getTen_ChatLieu());
    ...
    private boolean Checknull() {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (id.equalsIgnoreCase(list.get(i).getMa_ChatLieu())) {
                ...
                txtMa.requestFocus();
                return true;
            } else if (tensp.equalsIgnoreCase(list.get(i).getTen_ChatLieu())) {
