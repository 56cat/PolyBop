...
public class ThuongHieuJDiaLog extends javax.swing.JDialog {
    ...
    private void filltotableThuongHieu() {
        ...
        for (ThuongHieu x : list) {
            model.addRow(new Object[]{x.getMa_ThuongHieu(), x.getTen_ThuongHieu(), x.isTrangThai() ? "Còn Hàng" : "Hết Hàng"});
        }
...
//        txtMaVi.setText(sp.getIDVi() + "");
        ...
        txtTen.setText(sp.getTen_ThuongHieu());
    ...
    private boolean Checknull() {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (id.equalsIgnoreCase(list.get(i).getMa_ThuongHieu())) {
                ...
                txtMa.requestFocus();
                return true;
            } else if (tensp.equalsIgnoreCase(list.get(i).getTen_ThuongHieu())) {
